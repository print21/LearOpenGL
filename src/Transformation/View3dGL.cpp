...
View3dGL::View3dGL(QWidget * parent /*= nullptr*/, Qt::WindowFlags f /*= Qt::WindowFlags()*/)
    ...
    windowWidth(0), windowHeight(0), povWidth(0),
...
void View3dGL::initializeGL()
{
    ...
    glslSupported = glewIsSupported("GL_ARB_shader_objects");
    if (glslSupported)
    {
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setCamera(float posX, float posY, float posZ, float targetX, float targetY, float targetZ)
{
    float forward[4];
    float up[4];
    float left[4];
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setWindowSize(int width, int height)
{
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setViewportSub(int x, int y, int width, int height, float nearPlane, float farPlane)
{
    // set viewport
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::drawGrid(float size, float step)
{
    // disable lighting
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::drawAxis(float size)
{
...
// draw frustum
///////////////////////////////////////////////////////////////////////////////
void View3dGL::drawFrustum(float fovY, float aspectRatio, float nearPlane, float farPlane)
{
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setViewMatrix(float x, float y, float z, float pitch, float heading, float roll)
{
    cameraPosition[0] = x;
    cameraPosition[1] = y;
    cameraPosition[2] = z;
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setModelMatrix(float x, float y, float z, float rx, float ry, float rz)
{
    modelPosition[0] = x;
    modelPosition[1] = y;
    modelPosition[2] = z;
...
// update matrix
///////////////////////////////////////////////////////////////////////////////
void View3dGL::updateViewMatrix()
{
...
void View3dGL::updateModelMatrix()
{
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::rotateCamera(int x, int y)
{
...
///////////////////////////////////////////////////////////////////////////////
void View3dGL::zoomCamera(int y)
{
    cameraDistance -= (y - mouseY) * 0.1f;
    mouseY = y;
}
void View3dGL::zoomCameraDelta(float delta)
{
...
// change drawing mode
///////////////////////////////////////////////////////////////////////////////
void View3dGL::setDrawMode(int mode)
{
    if (drawMode != mode)
    {
...
///////////////////////////////////////////////////////////////////////////////
Matrix4 View3dGL::setFrustum(float l, float r, float b, float t, float n, float f)
{
    Matrix4 matrix;
    matrix[0] = 2 * n / (r - l);
    matrix[5] = 2 * n / (t - b);
...
///////////////////////////////////////////////////////////////////////////////
Matrix4 View3dGL::setFrustum(float fovY, float aspectRatio, float front, float back)
{
...
// Note: this is for row-major notation. OpenGL needs transpose it
///////////////////////////////////////////////////////////////////////////////
Matrix4 View3dGL::setOrthoFrustum(float l, float r, float b, float t, float n, float f)
{
    Matrix4 matrix;
    matrix[0] = 2 / (r - l);
    matrix[5] = 2 / (t - b);
...
///////////////////////////////////////////////////////////////////////////////
bool View3dGL::createShaderPrograms()
{
    ...
    {
        qInfo() << "=== GLSL LOG 1 ===\n" << getProgramStatus(progId1);
        qInfo() << "=== GLSL LOG 2 ===\n" << getProgramStatus(progId2);
        return false;
    }
}
...
///////////////////////////////////////////////////////////////////////////////
QString View3dGL::getShaderStatus(GLuint shader)
{
    QString message;
    GLint status;
    ...
    if (status == GL_FALSE)
    {
        ...
        message = QString::fromUtf8(buffer);       // copy
...
// if no errors, it returns empty string
///////////////////////////////////////////////////////////////////////////////
QString View3dGL::getProgramStatus(GLuint program)
{
    QString message;
    GLint status;
